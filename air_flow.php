...
<html>
<head>
    <title>Realtime Parameters | Air Flow</title>
...
<body>
    ...
    <h1 style="text-align: left; color:rgb(78, 187, 42);">AIR FLOW</h1>
    ...
    <!-- Cards -->
        <div class="section">
                ...
                <?php
                    ...
                    $sql = "SELECT flow_rate FROM air_flow ORDER BY timestamp DESC LIMIT 1";
                    $result = $conn->query($sql);
                ...
                <script>
                    document.addEventListener("DOMContentLoaded", function() {
                        ...
                        function fetchRealtimeData() {
                            fetch("fetch/fetch_air_flow.php?type=realtime")
                                .then(response => response.json())
                                .then(data => {
                                    // Update text values
                                    document.getElementById("airflow-value").innerText = data.flow_rate[0] + " FPM";

                                    // Update charts dynamically
                                    updateChart(chartAirFlow, data.flow_rate.reverse());
                                })
        ...
        <div class="section">
            ...
            <script>
                ...
                function fetchChartData(month) {
                    fetch(`fetch/fetch_air_flow_chart.php?month=${month}`)
                        .then(response => response.json())
                        .then(data => {
                            chart.updateOptions({
                                series: [
                                    { name: 'Air Flow (FPM)', data: data.flow_rate }
                                ],
